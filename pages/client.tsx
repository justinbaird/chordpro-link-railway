...
export default function ClientView() {
  ...
  useEffect(() => {
    ...
    client.connect().then(() => {
      setIsConnected(true);
      // Normalize session ID (lowercase, handle both formats)
      const normalizedSessionId = sessionIdParam.toLowerCase().trim();
      client.joinSession(normalizedSessionId).then((sessionInfo) => {
